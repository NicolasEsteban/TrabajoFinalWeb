 ...
 * @author Rodrigo
 */
public class VerBodega extends HttpServlet {
...
"  <div id=\"page-wrapper\">\n");
            ...
            out.println("<legend><h3>Lista de Bodegas</h3></legend>");
           ...
           out.println("</thead>");
             ...
             for(Bodega b : bo) {
                ...
                out.println("<td>"+ b.getNombre() +"</td>");
                
                 out.println("<td>");
               out.println("<form action=\"EliminarBodega\" method=\"post\">");
               out.println("<input type=\"hidden\" name=\"idP\" value=\""+b.getId()+"\"/>"); 
                out.println("<button type =\"submit\" class=\"btn btn-danger\"><i class=\"fa fa-trash\" style=\"font-size:20px;color:white\"></i></button>");
                out.println(" </form>");
                
                
                out.println("<form action=\"EditarBodega\" method=\"post\">");
               out.println("<input type=\"hidden\" name=\"id_p\" value=\""+b.getId()+"\"/>"); 
